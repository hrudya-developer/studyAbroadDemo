...
const Carousel = () => {
  ...
  return (
    <section className="relative mx-auto w-full max-w-7xl overflow-hidden">
      {/* Floating CTA */}
      <div className="absolute right-3 top-3 z-50 animate__animated animate__pulse sm:right-4 sm:top-4">
        <button
          type="button"
          className="
            talk-btn
      ...
      >
        {slides.map((slide, index) => (
          <SwiperSlide key={index} className="h-auto">
            <div className="relative min-h-[760px] w-full overflow-hidden sm:min-h-[760px] md:min-h-[720px] lg:min-h-[760px] xl:min-h-[800px]">
              {/* Responsive image */}
              ...
              <div className="relative z-10 flex min-h-[760px] w-full items-center sm:min-h-[760px] md:min-h-[720px] lg:min-h-[760px] xl:min-h-[760px]">
                <div
                  className="
                    ...
                    items-center px-4 py-28
                    sm:px-6 sm:py-28
                    md:items-start md:px-8 md:py-24
                    lg:px-10 xl:px-12
                  "
                >
                  <div className="flex w-full max-w-xl flex-col items-center text-center md:items-start md:text-left">
                    ...
                    <span
                      className="
                        mb-4 inline-flex max-w-full items-center gap-2
                        rounded-full border border-white px-4 py-2
                        text-xs font-bold text-white shadow-md
                        sm:text-sm
                        lg:border-0 lg:bg-logoYellow/90 lg:text-darkPrimary
                      "
                    >
                    ...
                    <p
                      className="
                        mx-auto mt-4 max-w-md font-nunito text-sm font-bold
                    ...
                    <div
                      className="
                        mt-6 flex w-full flex-col items-center gap-3
                    ...
                    >
                      ...
                      <a
                        ...
                        className="
                          ...
                          hover:text-white
                          sm:w-auto
                          lg:border-2 lg:border-darkPrimary lg:bg-transparent
                        "
                      >
                        Get Started
                      </a>
                    ...
                    {/* Stats - normal flow, always left with content */}
                    <div className="mt-8 w-full animate__animated animate__zoomInLeft sm:mt-10">
                      <div
                        className="
                          grid w-full grid-cols-2 overflow-hidden rounded-2xl
                          bg-black/35 shadow-xl backdrop-blur-sm
                          sm:grid-cols-4
                          md:max-w-2xl
                          lg:bg-white/70
                        "
                        ...
                        {stats.map((item, statIndex) => (
                          <div
                            ...
                            className="
                              ...
                              border-white/10 px-2 py-3 text-center font-nunito
                              odd:border-r
                               sm:border-r sm:last:border-r-0
                              lg:border-gray-200 lg:px-4 lg:py-4
                              xl:px-5
                            "
                          >
                            <div
                              className="
                                ...
                                bg-logoYellow text-darkPrimary shadow-sm
                                sm:size-11
                                lg:size-12 lg:bg-primary lg:text-white
                                xl:size-14
                              "
                            >
                              {item.icon}
                            ...
                            <p
                              className="
                                mt-1 text-[11px] font-bold leading-tight
                                text-white
                                sm:text-xs
                                lg:text-darkPrimary
                                xl:text-sm
