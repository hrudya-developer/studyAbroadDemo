...
const ProgramsSection = () => {
  return (
    <>
<div className="max-w-7xl mx-auto" data-aos="fade-right" id="ep_section">
  ...
  <h1 className="font-ubuntu font-bold text-3xl sm:text-3xl md:text-4xl lg:text-5xl mb-3 text-center text-secondary">Unlock Global <span className="text-primary">Opportunities</span></h1>
   ...
   <div className="grid grid-cols-1 place-content-center md:grid-cols-3 gap-3 justify-center mt-10 mx-5">

   
    <div className="flex flex-col gap-3 bg-[#d9ebff70] rounded-lg p-5 shadow-sm">
    ...
    <div className="flex flex-col gap-3 bg-[#fde2d6] rounded-lg p-5 shadow-sm">
